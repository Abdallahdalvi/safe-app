...
import com.dalvi.safe.models.json.signaling.settings.FederationSettings;
import com.dalvi.safe.models.json.websocket.ActorWebSocketMessage;
import com.dalvi.safe.models.json.websocket.AuthParametersWebSocketMessage;
import com.dalvi.safe.models.json.websocket.AuthWebSocketMessage;
import com.dalvi.safe.models.json.websocket.CallOverallWebSocketMessage;
import com.dalvi.safe.models.json.websocket.CallWebSocketMessage;
import com.dalvi.safe.models.json.websocket.HelloOverallWebSocketMessage;
import com.dalvi.safe.models.json.websocket.HelloWebSocketMessage;
import com.dalvi.safe.models.json.websocket.RoomFederationWebSocketMessage;
import com.dalvi.safe.models.json.websocket.RoomOverallWebSocketMessage;
import com.dalvi.safe.models.json.websocket.RoomWebSocketMessage;
...
public class WebSocketConnectionHelper {
    ...
    RoomOverallWebSocketMessage getAssembledJoinOrLeaveRoomModel(String roomId, String sessionId,
        ...
        if (federation != null) {
            ...
            roomFederationWebSocketMessage.setUrl(federation.getSafe AppServer() + "/ocs/v2.php/apps/spreed/api/v3/signaling/backend");
