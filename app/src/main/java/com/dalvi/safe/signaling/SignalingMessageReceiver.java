 ...
 */
package com.dalvi.safe.signaling;
...
import com.dalvi.safe.models.json.signaling.NCIceCandidate;
import com.dalvi.safe.models.json.signaling.NCMessagePayload;
...
public abstract class SignalingMessageReceiver {
    ...
    private void processParticipantsUpdate(Map<String, Object> updateMap) {
        ...
        // }
        //
        // Note that "userId" in participants->update comes from the Safe App server, so it is "userId"; in other
