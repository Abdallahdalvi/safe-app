...
import com.dalvi.safe.call.CallParticipantList
import com.dalvi.safe.call.LocalStateBroadcaster
import com.dalvi.safe.call.LocalStateBroadcasterMcu
import com.dalvi.safe.call.LocalStateBroadcasterNoMcu
import com.dalvi.safe.call.MediaConstraintsHelper
import com.dalvi.safe.call.MessageSender
import com.dalvi.safe.call.MessageSenderMcu
import com.dalvi.safe.call.MessageSenderNoMcu
import com.dalvi.safe.call.MutableLocalCallParticipantModel
import com.dalvi.safe.call.ReactionAnimator
import com.dalvi.safe.call.components.ParticipantGrid
import com.dalvi.safe.call.components.SelfVideoView
import com.dalvi.safe.call.components.screenshare.ScreenShareComponent
import com.dalvi.safe.chat.ChatActivity
import com.dalvi.safe.data.user.model.User
import com.dalvi.safe.databinding.CallActivityBinding
import com.dalvi.safe.events.ConfigurationChangeEvent
import com.dalvi.safe.events.NetworkEvent
import com.dalvi.safe.events.ProximitySensorEvent
import com.dalvi.safe.events.WebSocketCommunicationEvent
import com.dalvi.safe.models.ExternalSignalingServer
import com.dalvi.safe.models.json.capabilities.CapabilitiesOverall
...
import com.dalvi.safe.models.json.signaling.NCSignalingMessage
import com.dalvi.safe.models.json.signaling.Signaling
import com.dalvi.safe.models.json.signaling.SignalingOverall
...
import com.dalvi.safe.raisehand.viewmodel.RaiseHandViewModel.LoweredHandState
import com.dalvi.safe.raisehand.viewmodel.RaiseHandViewModel.RaisedHandState
import com.dalvi.safe.services.CallForegroundService
import com.dalvi.safe.signaling.SignalingMessageReceiver
import com.dalvi.safe.signaling.SignalingMessageReceiver.CallParticipantMessageListener
import com.dalvi.safe.signaling.SignalingMessageReceiver.LocalParticipantMessageListener
import com.dalvi.safe.signaling.SignalingMessageReceiver.OfferMessageListener
import com.dalvi.safe.signaling.SignalingMessageSender
import com.dalvi.safe.ui.dialog.AudioOutputDialog
import com.dalvi.safe.ui.dialog.MoreCallActionsDialog
...
import com.dalvi.safe.utils.CapabilitiesUtil.isCallRecordingAvailable
import com.dalvi.safe.utils.NotificationUtils.cancelExistingNotificationsForRoom
import com.dalvi.safe.utils.NotificationUtils.getCallRingtoneUri
import com.dalvi.safe.utils.ReceiverFlag
import com.dalvi.safe.utils.SpreedFeatures
import com.dalvi.safe.utils.VibrationUtils.vibrateShort
import com.dalvi.safe.utils.animations.PulseAnimation
import com.dalvi.safe.utils.bundle.BundleKeys.KEY_CALL_VOICE_ONLY
import com.dalvi.safe.utils.bundle.BundleKeys.KEY_CALL_WITHOUT_NOTIFICATION
import com.dalvi.safe.utils.bundle.BundleKeys.KEY_CONVERSATION_NAME
import com.dalvi.safe.utils.bundle.BundleKeys.KEY_CONVERSATION_PASSWORD
import com.dalvi.safe.utils.bundle.BundleKeys.KEY_FROM_NOTIFICATION_START_CALL
...
import com.dalvi.safe.utils.bundle.BundleKeys.KEY_MODIFIED_BASE_URL
import com.dalvi.safe.utils.bundle.BundleKeys.KEY_PARTICIPANT_PERMISSION_CAN_PUBLISH_AUDIO
import com.dalvi.safe.utils.bundle.BundleKeys.KEY_PARTICIPANT_PERMISSION_CAN_PUBLISH_VIDEO
import com.dalvi.safe.utils.bundle.BundleKeys.KEY_RECORDING_STATE
import com.dalvi.safe.utils.bundle.BundleKeys.KEY_ROOM_ID
import com.dalvi.safe.utils.bundle.BundleKeys.KEY_ROOM_ONE_TO_ONE
...
import com.dalvi.safe.utils.power.PowerManagerUtils
import com.dalvi.safe.utils.registerPermissionHandlerBroadcastReceiver
...
import com.dalvi.safe.viewmodels.CallRecordingViewModel.RecordingConfirmStopState
import com.dalvi.safe.viewmodels.CallRecordingViewModel.RecordingErrorState
import com.dalvi.safe.viewmodels.CallRecordingViewModel.RecordingStartedState
import com.dalvi.safe.viewmodels.CallRecordingViewModel.RecordingStartingState
import com.dalvi.safe.webrtc.PeerConnectionWrapper
import com.dalvi.safe.webrtc.PeerConnectionWrapper.PeerConnectionObserver
import com.dalvi.safe.webrtc.WebRTCUtils
import com.dalvi.safe.webrtc.WebRtcAudioManager
import com.dalvi.safe.webrtc.WebRtcAudioManager.AudioDevice
...
class CallActivity : CallBaseActivity() {
    ...
    private fun handleCallParticipantsChanged(
        ...
        // The signaling session is the same as the Safe App session only when the MCU is not used.
    ...
    private fun playCallingSound() {
        ...
        if (ringtoneUri != null) {
            ...
            try {
                ...
                if (isIncomingCallFromNotification) {
                    VibrationUtils.vibratePersistent(this)
                }
            } catch (e: IOException) {
