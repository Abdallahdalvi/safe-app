...
import com.dalvi.safe.utils.LoggingUtils;
import com.dalvi.safe.utils.preferences.AppPreferences;
import com.dalvi.safe.utils.ssl.KeyManager;
import com.dalvi.safe.utils.ssl.SSLSocketFactoryCompat;
...
public class RestModule {
    ...
    Cache provideCache() {
        ...
        return new Cache(SafeAppApplication.Companion.getSharedApplication().getCacheDir(), cacheSize);
    }
